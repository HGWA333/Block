...
contract nftToken is ERC721Enumerable, Ownable {
  uint public constant MAX_TOKENT_COUNT = 1000;
  ...
  function tokenURI(
    ...
    string memory Type = string.toString(TokenDatas[_tokenId].Type);
    return string(abi.encodePacked(metadataURI, "/", Rank, "/", Type, ".json"));
  }

  function mintToken() public payable {
    require(msg.value >= mint_price);
    require(MAX_TOKENT_COUNT > ERC721Enumerable.totalSupply());
